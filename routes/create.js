...
async function translateText(content, lang) {
    let messages = [
        ...
        { role: "user", content: "Please translate the following text into Japanese. I only need the translated output, without any additional comments or indicators. When translating into Korean or Japanese, be respectful to the reader through the overall tone, but do not apply honorifics to the people, organizations, places, or entities mentioned in the article. Text: [마켓뷰] '금리 인하 이르다고?' 美 물가지표 지켜보자"},
        { role: "assistant", content: "[マーケットビュー]「金利引き下げは早い？」米国の物価指標を注視しよう"},
        { role: "user", content: `Please translate the following text into ${lang}. I only need the translated output, without any additional comments or indicators. When translating into Korean or Japanese, be respectful to the reader through the overall tone, but do not apply honorifics to the people, organizations, places, or entities mentioned in the article. Text: ${content}`},
    ];
